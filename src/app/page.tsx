    ...
    <div className="pt-8 pb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <h1 className="text-[44px] leading-[1.08] tracking-[-1px] text-[var(--color-text-primary)]">
            Apprenez l&apos;économie <em className="text-[#065F46] italic">en simulant</em>
          </h1>

          <p className="text-[15px] text-[var(--color-text-secondary)] max-w-[380px] leading-[1.7]">
            Light Vector est une plateforme d&apos;apprentissage interactive qui transforme les concepts de la macroéconomie en expériences visuelles et manipulables.
          </p>
        ...
        <div className="bg-white rounded-[12px] p-5 border-[0.5px] border-[var(--color-border-tertiary)] flex flex-col min-h-[340px] shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
          ...
          <svg viewBox="0 0 320 220" className="w-full flex-1">
            ...
            {/* Ménages node */}
            <rect x="10" y="110" width="80" height="44" rx="6" fill="#ECFDF5" stroke="#065F46ff" strokeWidth="1" />
            <text x="50" y="131" textAnchor="middle" fontFamily="var(--font-dm-mono)" fontSize="8" fill="#064E3B" fontWeight="500">MÉNAGES</text>
            ...
            <path d="M 70 110 Q 100 60 130 40" fill="none" stroke="#065F46" strokeWidth="1.5" strokeDasharray="4 3" className="flow1" markerEnd="url(#heroArrow)" />
            <text x="85" y="68" fontFamily="var(--font-dm-mono)" fontSize="6" fill="#065F46">Impôts T</text>
            ...
            <path d="M 120 180 Q 90 170 70 154" fill="none" stroke="#065F46" strokeWidth="1.5" strokeDasharray="4 3" className="flow2" markerEnd="url(#heroArrow)" />
            <text x="75" y="178" fontFamily="var(--font-dm-mono)" fontSize="6" fill="#065F46">Conso C</text>
          ...
          <Link href="/simulateurs" className="h-full">
            <div className="h-full bg-white rounded-[12px] p-5 border-[0.5px] border-[var(--color-border-tertiary)] hover:border-[var(--color-border-secondary)] hover:-translate-y-[1px] transition-all shadow-sm flex flex-col">
              <div className="w-9 h-9 rounded-lg bg-[#ECFDF5] flex items-center justify-center mb-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#065F46" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
              </div>
              ...
              <div>
                <span className="font-mono text-[10px] bg-[#ECFDF5] text-[#064E3B] px-2 py-1 rounded">14 thèmes</span>
              </div>
            </div>
          </Link>
          {/* Circuit */}
      ...
      <div className="mt-16">
        <div className="flex items-center gap-2 mb-4">
          <span className="relative flex h-2 w-2"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#065F46] opacity-75"></span><span className="relative inline-flex rounded-full h-2 w-2 bg-[#065F46]"></span></span>
      ...
      <footer className="mt-20 pt-6 border-t-[0.5px] border-[var(--color-border-tertiary)] flex items-center justify-between">
        <div className="font-mono text-[11px] text-[var(--color-text-tertiary)] flex flex-col gap-1">
          <div>© 2026 Light Vector — Économie Générale</div>
