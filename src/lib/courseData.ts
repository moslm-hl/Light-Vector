...
export const themes: ThemeContent[] = [
  ...
  },
  {
    ...
    keyConcepts: [
      { term: 'Subprimes', definition: "Crédits hypothécaires à haut risque accordés à des ménages peu solvables" },
      { term: 'Titrisation', definition: "Transformation de créances en titres négociables (CDO/MBS)" },
      { term: 'Credit Crunch', definition: "Assèchement brutal du crédit entre les banques" },
      { term: 'Aléa Moral', definition: "Banques prenant trop de risques car se sachant 'Too Big to Fail'" },
    ],
    formulas: [
  ...
  },
  {
    ...
    keyConcepts: [
      { term: 'Change Fixe', definition: "Parité stable garantie par la BC. Perte d'autonomie monétaire (Trinité d'impossible)." },
      { term: 'Change Flottant', definition: "Déterminé par le marché. Ajustement automatique de la balance." },
      { term: 'Marshall-Lerner', definition: "|εX| + |εM| > 1 : condition pour qu'une dépréciation améliore le solde." },
      { term: 'Courbe en J', definition: "Dégradation initiale (effet-prix) puis amélioration (effet-volume) après dépréciation." },
      { term: 'Mundell-Fleming', definition: "Extension d'IS-LM à l'économie ouverte (IS-LM-BP)." },
    ],
    formulas: [
      { expression: 'Zr = Z × (P*/P)', description: "Taux de change réel", variables: { Z: 'taux nominal', 'P*': 'prix étrangers', P: 'prix locaux' } },
      { expression: '|εX| + |εM| > 1', description: "Marshall-Lerner", variables: { 'ε': 'élasticité-prix' } },
    ],
    examples: [
      { title: 'Dinar Tunisien', description: "Passage d'un ancrage fixe à un flottement dirigé vers l'euro et le dollar." },
    ],
  },
  {
  ...
  {
    id: '12', slug: 'financement', title: 'Financement pipeline', category: 'monnaie',
    definition: "Mise en relation des épargnants et des investisseurs. Crucial pour la création de richesse.",
    keyConcepts: [
      { term: 'Autofinancement', definition: "Financement par les ressources propres (épargne)" },
      { term: 'Intermédiation', definition: "Passage par le système bancaire (Financement indirect)" },
      { term: 'Marchés Financiers', definition: "Rencontre directe en bourse (Financement direct)" },
      { term: 'Désintermédiation', definition: "Réduction du rôle des banques au profit des marchés" },
    ],
    formulas: [
      { expression: 'M = m × B', description: "Multiplicateur de crédit", variables: { M: 'masse monétaire', m: 'multiplicateur', B: 'base monétaire' } },
      { expression: 'm = 1 / (r + e)', description: "Calcul du multiplicateur", variables: { r: 'réserves', e: 'billets' } },
    ],
    examples: [
      { title: 'Marché Primaire', description: "Lieu d'émission des nouveaux titres (Actions/Obligations)." },
    ],
  },
  {
